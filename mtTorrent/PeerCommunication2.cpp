...
PeerCommunication2::PeerCommunication2(TorrentInfo& t, IPeerListener& l, boost::asio::io_service& io_service) : torrent(t), listener(l)
{
...
mtt::PeerCommunication2::~PeerCommunication2()
{
